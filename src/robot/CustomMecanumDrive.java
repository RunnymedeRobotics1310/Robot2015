...
/**
 * This drive was created to fix a bug in the FRC wpilib.
 * <p>
 * The setInvertedMotor method used to take a MotorType as a parameter which is not accessible.  The 
 * code was changed to accept an integer value, and the integer values FRONT_LEFT_MOTOR, FRONT_RIGHT_MOTOR,
 * REAR_LEFT_MOTOR, and REAR_RIGHT_MOTOR were created.  These should be used as input parameters to the
 * setInvertedMotor command. 
 * <p>
 ...
 */
public class CustomMecanumDrive implements MotorSafety {
     ...
     */
    public CustomMecanumDrive(final int leftMotorChannel, final int rightMotorChannel) {
     ...
     */
    public CustomMecanumDrive(final int frontLeftMotor, final int rearLeftMotor,
     ...
     */
    public CustomMecanumDrive(SpeedController leftMotor, SpeedController rightMotor) {
     ...
     */
    public CustomMecanumDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
