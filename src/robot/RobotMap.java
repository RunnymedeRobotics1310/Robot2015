...
//	public static final double MAX_DRIVE_ACCELERATION = .5; // change in motor speed control / sec
	...
	public static final double TOTE_ELEVATOR_MAX_ELEVATOR_ENCODER_RATE = 1000;
	public static final double TOTE_ELEVATOR_ENCODER_COUNTS_PER_ELEVATOR_LEVEL = 1000;
	public static final double TOTE_ELEVATOR_ENCODER_COUNTS_AT_FIRST_LEVEL = 1500;
	
	public static final double CONTAINER_ELEVATOR_MAX_ELEVATOR_ENCODER_RATE = 200;
